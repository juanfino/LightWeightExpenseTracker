...
- `system_errors` persistence — unhandled web and Telegram exceptions are logged/notified as before and, when a family has already been resolved, stored tenant-scoped for `/superadmin`. Pre-auth/unresolved errors cannot be stored in this RLS table.
